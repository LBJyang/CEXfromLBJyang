...
import hongze.myCEX.bean.AuthToken;
import hongze.myCEX.bean.TransferRequestBean;
...
import hongze.myCEX.user.UserService;
...
public class MvcController extends LoggerSupport {
	...
	private UserProfileEntity doSignup(String email, String name, String password) {
		...
		if (isLocalDevEnv()) {
			...
			deposit(profile.userId, AssetEnum.USDT,
